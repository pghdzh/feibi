<template>
  <div class="ack-page">
    ...
    <footer class="ack-footer">© 2025 菲比电子设定集 · 感谢所有支持者</footer>
  </div>
</template>
...
const acknowledgements = reactive([
  ...
  {
    nickname: "克里斯托弗x",
    suggestion: "小游戏失败时放菲比表情包(功能建议)",
  },
  {
    nickname: "克里斯托弗x",
    suggestion: "把菲比写过的信件放在文本分享页面(功能建议)",
  },
  {
    nickname: "大厨小露",
    suggestion: "把菲比库街区人物介绍放在资源分享页面(功能建议)",
  },
  {
    nickname: "大厨小露",
  ...
  {
    nickname: "随风漂泊的冒险家",
    suggestion: "小游戏管道小鸟重构为菲比风格(功能建议)",
  },
   {
    nickname: "风所教会她的",
